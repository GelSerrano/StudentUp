...
public class prelimLinks4and5 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_prelim_links4and5);
        ...
        TextView text6 = (TextView) findViewById(R.id.link6);
        text6.setMovementMethod(LinkMovementMethod.getInstance());
        TextView text7 = (TextView) findViewById(R.id.link7);
