...
public class prelim_quiz3 extends AppCompatActivity {
    Button submit;
    int total = 0;
    int correct = 0;
    int wrong = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_prelim_quiz3);
...
//storing history stuff
                        String pq3_h1_pref = sharedPreferences.getString("pq3_h1_date", null);
                        if(pq3_h1_pref == null) {
                            myEdit.putString("pq3_h1_date",currdate);
                            myEdit.putInt("pq3_h1_score", correct);
                            myEdit.commit();

                            myEdit.putString("test","test");
                            Log.i("SP_", "pq3_h1 processed");

                        } else {
                            String pq3_h2_pref = sharedPreferences.getString("pq3_h2_date", null);
                            if (pq3_h2_pref == null) {
                                myEdit.putString("pq3_h2_date", currdate);
                                myEdit.putInt("pq3_h2_score", correct);
                                myEdit.commit();
                                Log.i("SP_", "pq3_h2 processed");
                            } else {
                                String pq3_h3_pref = sharedPreferences.getString("pq3_h3_date", null);
                                if (pq3_h3_pref == null) {
                                    myEdit.putString("pq3_h3_date", currdate);
                                    myEdit.putInt("pq3_h3_score", correct);
                                    myEdit.commit();
                                    Log.i("SP_", "pq3_h3 processed");
                                } else {

                                    String pq3_h4_pref = sharedPreferences.getString("pq3_h4_date", null);
                                    if (pq3_h4_pref == null) {
                                        myEdit.putString("pq3_h4_date", currdate);
                                        myEdit.putInt("pq3_h4_score", correct);
                                        myEdit.commit();
                                        Log.i("SP_", "pq3_h4 processed");
                                    } else {
                                        String pq3_h5_pref = sharedPreferences.getString("pq3_h5_date", null);
                                        if (pq3_h5_pref == null) {
                                            myEdit.putString("pq3_h5_date", currdate);
                                            myEdit.putInt("pq3_h5_score", correct);
                                            myEdit.commit();
                                            Log.i("SP_", "pq3_h5 processed");
                                        } else{
                                            String pq3_h6_pref = sharedPreferences.getString("pq3_h6_date", null);
                                            if (pq3_h6_pref == null) {
                                                myEdit.putString("pq3_h6_date", currdate);
                                                myEdit.putInt("pq3_h6_score", correct);
                                                myEdit.commit();
                                                Log.i("SP_", "pq3_h6 processed");
                                            }else{
                                                String pq3_h7_pref = sharedPreferences.getString("pq3_h7_date", null);
                                                if (pq3_h7_pref == null) {
                                                    myEdit.putString("pq3_h7_date", currdate);
                                                    myEdit.putInt("pq3_h7_score", correct);
                                                    myEdit.commit();
                                                    Log.i("SP_", "pq3_h7 processed");
                                                }else{
                                                    String pq3_h8_pref = sharedPreferences.getString("pq3_h8_date", null);
                                                    if (pq3_h8_pref == null) {
                                                        myEdit.putString("pq3_h8_date", currdate);
                                                        myEdit.putInt("pq3_h8_score", correct);
                                                        myEdit.commit();
                                                        Log.i("SP_", "pq3_h8 processed");
                                                    }else{
                                                        String pq3_h9_pref = sharedPreferences.getString("pq3_h9_date", null);
                                                        if (pq3_h9_pref == null) {
                                                            myEdit.putString("pq3_h9_date", currdate);
                                                            myEdit.putInt("pq3_h9_score", correct);
                                                            myEdit.commit();
                                                            Log.i("SP_", "pq3_h9 processed");
                                                        }else{
                                                            String pq3_h10_pref = sharedPreferences.getString("pq3_h10_date", null);
                                                            if (pq3_h10_pref == null) {
                                                                myEdit.putString("pq3_h10_date", currdate);
                                                                myEdit.putInt("pq3_h10_score", correct);
                                                                myEdit.commit();
                                                                Log.i("SP_", "pq3_h10 processed");
                                                            }else{
                                                                Log.i("SP_","history is full");

                                                                //adjusts entries 2 to 1, 3 to 2 and so on
                                                                myEdit.putString("pq3_h1_date",  sharedPreferences.getString("pq3_h2_date", ""));
                                                                myEdit.putInt("pq3_h1_score", sharedPreferences.getInt("pq3_h2_score", 0));

                                                                myEdit.putString("pq3_h2_date",  sharedPreferences.getString("pq3_h3_date", ""));
                                                                myEdit.putInt("pq3_h2_score", sharedPreferences.getInt("pq3_h3_score", 0));

                                                                myEdit.putString("pq3_h3_date",  sharedPreferences.getString("pq3_h4_date", ""));
                                                                myEdit.putInt("pq3_h3_score", sharedPreferences.getInt("pq3_h4_score", 0));

                                                                myEdit.putString("pq3_h4_date",  sharedPreferences.getString("pq3_h5_date", ""));
                                                                myEdit.putInt("pq3_h4_score", sharedPreferences.getInt("pq3_h5_score", 0));

                                                                myEdit.putString("pq3_h5_date",  sharedPreferences.getString("pq3_h6_date", ""));
                                                                myEdit.putInt("pq3_h5_score", sharedPreferences.getInt("pq3_h6_score", 0));

                                                                myEdit.putString("pq3_h6_date",  sharedPreferences.getString("pq3_h7_date", ""));
                                                                myEdit.putInt("pq3_h6_score", sharedPreferences.getInt("pq3_h7_score", 0));

                                                                myEdit.putString("pq3_h7_date",  sharedPreferences.getString("pq3_h8_date", ""));
                                                                myEdit.putInt("pq3_h7_score", sharedPreferences.getInt("pq3_h8_score", 0));

                                                                myEdit.putString("pq3_h8_date",  sharedPreferences.getString("pq3_h9_date", ""));
                                                                myEdit.putInt("pq3_h8_score", sharedPreferences.getInt("pq3_h9_score", 0));

                                                                myEdit.putString("pq3_h9_date",  sharedPreferences.getString("pq3_h10_date", ""));
                                                                myEdit.putInt("pq3_h9_score", sharedPreferences.getInt("pq3_h10_score", 0));
                                                                //adjusts entries 2 to 1, 3 to 2 and so on
                                                                myEdit.putString("pq3_h10_date", currdate);
                                                                myEdit.putInt("pq3_h10_score", correct);
                                                                myEdit.commit();
                        ...
                        String q3_h2_d = sharedPreferences.getString("pq3_h2_date", "");
                        int q3_h3_s = sharedPreferences.getInt("pq3_h3_score", 0);
                        String q3_h3_d = sharedPreferences.getString("pq3_h3_date", "");
                        int q3_h4_s = sharedPreferences.getInt("pq3_h4_score", 0);
                        String q3_h4_d = sharedPreferences.getString("pq3_h4_date", "");
                        int q3_h5_s = sharedPreferences.getInt("pq3_h5_score", 0);
                        String q3_h5_d = sharedPreferences.getString("pq3_h5_date", "");
                        int q3_h6_s = sharedPreferences.getInt("pq3_h6_score", 0);
                        String q3_h6_d = sharedPreferences.getString("pq3_h6_date", "");
                        int q3_h7_s = sharedPreferences.getInt("pq3_h7_score", 0);
                        String q3_h7_d = sharedPreferences.getString("pq3_h7_date", "");
                        int q3_h8_s = sharedPreferences.getInt("pq3_h8_score", 0);
                        String q3_h8_d = sharedPreferences.getString("pq3_h8_date", "");
                        int q3_h9_s = sharedPreferences.getInt("pq3_h9_score", 0);
                        String q3_h9_d = sharedPreferences.getString("pq3_h9_date", "");
                        int q3_h10_s = sharedPreferences.getInt("pq3_h10_score", 0);
                        String q3_h10_d = sharedPreferences.getString("pq3_h10_date", "");
                        Log.i("SP_content", "" );
                        Log.i("SP_content", "h1: "+ q3_h1_d +" "+ q3_h1_s );
                        Log.i("SP_content", "h2: "+ q3_h2_d +" "+ q3_h2_s );
                        Log.i("SP_content", "h3: "+ q3_h3_d +" "+ q3_h3_s );
                        Log.i("SP_content", "h4: "+ q3_h4_d +" "+ q3_h4_s );
                        Log.i("SP_content", "h5: "+ q3_h5_d +" "+ q3_h5_s );
                        Log.i("SP_content", "h6: "+ q3_h6_d +" "+ q3_h6_s );
                        Log.i("SP_content", "h7: "+ q3_h7_d +" "+ q3_h7_s );
                        Log.i("SP_content", "h8: "+ q3_h8_d +" "+ q3_h8_s );
                        Log.i("SP_content", "h9: "+ q3_h9_d +" "+ q3_h9_s );
                        Log.i("SP_content", "h10: "+ q3_h10_d +" "+ q3_h10_s );
...
//                        myEdit.commit();
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(prelim_quiz3.this)
                        ...
                        positiveButton1.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                AlertDialog dialog1 = new AlertDialog.Builder(prelim_quiz3.this)
                                        .setTitle("Score")
                                ...
                                positiveButton.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent intent = new Intent(prelim_quiz3.this, Lecture.class);
