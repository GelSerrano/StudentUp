...
public class midterm_quiz9 extends AppCompatActivity {
    Button submit;
    int total = 0;
    int correct = 0;
    int wrong = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = getSharedPreferences("M_Q9SharedPref",MODE_PRIVATE);
...
//EditText
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference().child("Quizzes/week9");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                submit.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        String mq9_h1_pref = sharedPreferences.getString("mq9_h1_date", null);
                        if(mq9_h1_pref == null) {
                            myEdit.putString("mq9_h1_date",currdate);
                            myEdit.putInt("mq9_h1_score", correct);
                            myEdit.commit();

                            myEdit.putString("test","test");
                            Log.i("SP_", "mq9_h1 processed");

                        } else {
                            String mq9_h2_pref = sharedPreferences.getString("mq9_h2_date", null);
                            if (mq9_h2_pref == null) {
                                myEdit.putString("mq9_h2_date", currdate);
                                myEdit.putInt("mq9_h2_score", correct);
                                myEdit.commit();
                                Log.i("SP_", "mq9_h2 processed");
                            } else {
                                String mq9_h3_pref = sharedPreferences.getString("mq9_h3_date", null);
                                if (mq9_h3_pref == null) {
                                    myEdit.putString("mq9_h3_date", currdate);
                                    myEdit.putInt("mq9_h3_score", correct);
                                    myEdit.commit();
                                    Log.i("SP_", "mq9_h3 processed");
                                } else {

                                    String mq9_h4_pref = sharedPreferences.getString("mq9_h4_date", null);
                                    if (mq9_h4_pref == null) {
                                        myEdit.putString("mq9_h4_date", currdate);
                                        myEdit.putInt("mq9_h4_score", correct);
                                        myEdit.commit();
                                        Log.i("SP_", "mq9_h4 processed");
                                    } else {
                                        String mq9_h5_pref = sharedPreferences.getString("mq9_h5_date", null);
                                        if (mq9_h5_pref == null) {
                                            myEdit.putString("mq9_h5_date", currdate);
                                            myEdit.putInt("mq9_h5_score", correct);
                                            myEdit.commit();
                                            Log.i("SP_", "mq9_h5 processed");
                                        } else{
                                            String mq9_h6_pref = sharedPreferences.getString("mq9_h6_date", null);
                                            if (mq9_h6_pref == null) {
                                                myEdit.putString("mq9_h6_date", currdate);
                                                myEdit.putInt("mq9_h6_score", correct);
                                                myEdit.commit();
                                                Log.i("SP_", "mq9_h6 processed");
                                            }else{
                                                String mq9_h7_pref = sharedPreferences.getString("mq9_h7_date", null);
                                                if (mq9_h7_pref == null) {
                                                    myEdit.putString("mq9_h7_date", currdate);
                                                    myEdit.putInt("mq9_h7_score", correct);
                                                    myEdit.commit();
                                                    Log.i("SP_", "mq9_h7 processed");
                                                }else{
                                                    String mq9_h8_pref = sharedPreferences.getString("mq9_h8_date", null);
                                                    if (mq9_h8_pref == null) {
                                                        myEdit.putString("mq9_h8_date", currdate);
                                                        myEdit.putInt("mq9_h8_score", correct);
                                                        myEdit.commit();
                                                        Log.i("SP_", "mq9_h8 processed");
                                                    }else{
                                                        String mq9_h9_pref = sharedPreferences.getString("mq9_h9_date", null);
                                                        if (mq9_h9_pref == null) {
                                                            myEdit.putString("mq9_h9_date", currdate);
                                                            myEdit.putInt("mq9_h9_score", correct);
                                                            myEdit.commit();
                                                            Log.i("SP_", "mq9_h9 processed");
                                                        }else{
                                                            String mq9_h10_pref = sharedPreferences.getString("mq9_h10_date", null);
                                                            if (mq9_h10_pref == null) {
                                                                myEdit.putString("mq9_h10_date", currdate);
                                                                myEdit.putInt("mq9_h10_score", correct);
                                                                myEdit.commit();
                                                                Log.i("SP_", "mq9_h10 processed");
                                                            }else{
                                                                Log.i("SP_","history is full");

                                                                //adjusts entries 2 to 1, 3 to 2 and so on
                                                                myEdit.putString("mq9_h1_date",  sharedPreferences.getString("mq9_h2_date", ""));
                                                                myEdit.putInt("mq9_h1_score", sharedPreferences.getInt("mq9_h2_score", 0));

                                                                myEdit.putString("mq9_h2_date",  sharedPreferences.getString("mq9_h3_date", ""));
                                                                myEdit.putInt("mq9_h2_score", sharedPreferences.getInt("mq9_h3_score", 0));

                                                                myEdit.putString("mq9_h3_date",  sharedPreferences.getString("mq9_h4_date", ""));
                                                                myEdit.putInt("mq9_h3_score", sharedPreferences.getInt("mq9_h4_score", 0));

                                                                myEdit.putString("mq9_h4_date",  sharedPreferences.getString("mq9_h5_date", ""));
                                                                myEdit.putInt("mq9_h4_score", sharedPreferences.getInt("mq9_h5_score", 0));

                                                                myEdit.putString("mq9_h5_date",  sharedPreferences.getString("mq9_h6_date", ""));
                                                                myEdit.putInt("mq9_h5_score", sharedPreferences.getInt("mq9_h6_score", 0));

                                                                myEdit.putString("mq9_h6_date",  sharedPreferences.getString("mq9_h7_date", ""));
                                                                myEdit.putInt("mq9_h6_score", sharedPreferences.getInt("mq9_h7_score", 0));

                                                                myEdit.putString("mq9_h7_date",  sharedPreferences.getString("mq9_h8_date", ""));
                                                                myEdit.putInt("mq9_h7_score", sharedPreferences.getInt("mq9_h8_score", 0));

                                                                myEdit.putString("mq9_h8_date",  sharedPreferences.getString("mq9_h9_date", ""));
                                                                myEdit.putInt("mq9_h8_score", sharedPreferences.getInt("mq9_h9_score", 0));

                                                                myEdit.putString("mq9_h9_date",  sharedPreferences.getString("mq9_h10_date", ""));
                                                                myEdit.putInt("mq9_h9_score", sharedPreferences.getInt("mq9_h10_score", 0));
                                                                //adjusts entries 2 to 1, 3 to 2 and so on
                                                                myEdit.putString("mq9_h10_date", currdate);
                                                                myEdit.putInt("mq9_h10_score", correct);
                                                                myEdit.commit();
                        ...
                        sharedPreferences  = getSharedPreferences("M_Q9SharedPref", MODE_PRIVATE);
                        int q9_h1_s = sharedPreferences.getInt("mq9_h1_score", 0);
                        String q9_h1_d = sharedPreferences.getString("mq9_h1_date", "");
                        int q9_h2_s = sharedPreferences.getInt("mq9_h2_score", 0);
                        String q9_h2_d = sharedPreferences.getString("mq9_h2_date", "");
                        int q9_h3_s = sharedPreferences.getInt("mq9_h3_score", 0);
                        String q9_h3_d = sharedPreferences.getString("mq9_h3_date", "");
                        int q9_h4_s = sharedPreferences.getInt("mq9_h4_score", 0);
                        String q9_h4_d = sharedPreferences.getString("mq9_h4_date", "");
                        int q9_h5_s = sharedPreferences.getInt("mq9_h5_score", 0);
                        String q9_h5_d = sharedPreferences.getString("mq9_h5_date", "");
                        int q9_h6_s = sharedPreferences.getInt("mq9_h6_score", 0);
                        String q9_h6_d = sharedPreferences.getString("mq9_h6_date", "");
                        int q9_h7_s = sharedPreferences.getInt("mq9_h7_score", 0);
                        String q9_h7_d = sharedPreferences.getString("mq9_h7_date", "");
                        int q9_h8_s = sharedPreferences.getInt("mq9_h8_score", 0);
                        String q9_h8_d = sharedPreferences.getString("mq9_h8_date", "");
                        int q9_h9_s = sharedPreferences.getInt("mq9_h9_score", 0);
                        String q9_h9_d = sharedPreferences.getString("mq9_h9_date", "");
                        int q9_h10_s = sharedPreferences.getInt("mq9_h10_score", 0);
                        String q9_h10_d = sharedPreferences.getString("mq9_h10_date", "");
                        Log.i("SP_content", "" );
                        Log.i("SP_content", "h1: "+ q9_h1_d +" "+ q9_h1_s );
                        Log.i("SP_content", "h2: "+ q9_h2_d +" "+ q9_h2_s );
                        Log.i("SP_content", "h3: "+ q9_h3_d +" "+ q9_h3_s );
                        Log.i("SP_content", "h4: "+ q9_h4_d +" "+ q9_h4_s );
                        Log.i("SP_content", "h5: "+ q9_h5_d +" "+ q9_h5_s );
                        Log.i("SP_content", "h6: "+ q9_h6_d +" "+ q9_h6_s );
                        Log.i("SP_content", "h7: "+ q9_h7_d +" "+ q9_h7_s );
                        Log.i("SP_content", "h8: "+ q9_h8_d +" "+ q9_h8_s );
                        Log.i("SP_content", "h9: "+ q9_h9_d +" "+ q9_h9_s );
                        Log.i("SP_content", "h10: "+ q9_h10_d +" "+ q9_h10_s );
...
//                        myEdit.commit();
                        ...
                        AlertDialog dialog = new AlertDialog.Builder(midterm_quiz9.this)
                        ...
                        positiveButton1.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                AlertDialog dialog1 = new AlertDialog.Builder(midterm_quiz9.this)
                                        .setTitle("Score")
                                ...
                                positiveButton.setOnClickListener(new View.OnClickListener() {
                                    @Override
                                    public void onClick(View v) {
                                        Intent intent = new Intent(midterm_quiz9.this, lecture_midterm.class);
